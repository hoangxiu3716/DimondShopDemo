...
<!-- https://youtu.be/6qmtFqNGbWI?list=PLZusWOyEknKxUlNczNj7-ko9docmwjCKK&t=835 -->
				<ul id="productDetail" class="nav nav-tabs">
					<li class="active"><a href="#home" data-toggle="tab">Chi tiết sản phẩm</a></li>
					<li class=""><a href="#profile" data-toggle="tab">Sản phẩm liên quan</a></li></ul>
				<div id="myTabContent" class="tab-content tabWrapper">
					...
					<c:if test="${ productByCategoryId.size() > 10 }">
						<c:set var="countList" value="10"/>
					</c:if>
					<c:forEach var="item" begin="1" end="${ countList }" items="${ productByCategoryId }">
						<div class="row-fluid">
							<div class="span2">
