...
<body>
	<!-- 
	Upper Header Section ${ TotalPriceCart }
-->
			...
			<div class="container">
				<div class="alignR">
					...
					<a class="active" href="index.html"> <span class="icon-home"></span>
						...
						class="badge badge-warning"><fmt:formatNumber type="number" groupingUsed="true" value="${ TotalPriceCart } "/>&nbsp;₫
				</div>
			</div>
		</div>
	</div>
...
<%-- <c:url value="/assets/user/img/disc.png" /> --%>
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
